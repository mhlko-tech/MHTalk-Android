...
Private invitations are intended only for invited participants. Do not publish a private code unless you intend to allow anyone who receives it to enter while it remains valid.

MHTalk is provided without a guarantee of uninterrupted availability. Network, device, platform and third-party service conditions can affect calls. The app attempts automatic recovery when a connection is interrupted.

For help or reports, use the in-app reporting controls or contact `@m.ed1t` on Instagram.
